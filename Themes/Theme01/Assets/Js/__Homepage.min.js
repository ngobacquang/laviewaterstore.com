 ...
 * http://jquery.org/license
 */
n.widget("ui.tooltip",{version:"1.12.1",options:{classes:{"ui-tooltip":"ui-corner-all ui-widget-shadow"},content:function(){var t=n(this).attr("title")||"";return n("<a>").text(t).html()},hide:!0,items:"[title]:not([disabled])",position:{my:"left top+15",at:"left bottom",collision:"flipfit flip"},show:!0,track:!1,close:null,open:null},_addDescribedBy:function(t,i){var r=(t.attr("aria-describedby")||"").split(/\s+/);r.push(i);t.data("ui-tooltip-id",i).attr("aria-describedby",n.trim(r.join(" ")))},_removeDescribedBy:function(t){var u=t.data("ui-tooltip-id"),i=(t.attr("aria-describedby")||"").split(/\s+/),r=n.inArray(u,i);r!==-1&&i.splice(r,1);t.removeData("ui-tooltip-id");i=n.trim(i.join(" "));i?t.attr("aria-describedby",i):t.removeAttr("aria-describedby")},_create:function(){this._on({mouseover:"open",focusin:"open"});this.tooltips={};this.parents={};this.liveRegion=n("<div>").attr({role:"log","aria-live":"assertive","aria-relevant":"additions"}).appendTo(this.document[0].body);this._addClass(this.liveRegion,null,"ui-helper-hidden-accessible");this.disabledTitles=n([])},_setOption:function(t,i){var r=this;this._super(t,i);t==="content"&&n.each(this.tooltips,function(n,t){r._updateContent(t.element)})},_setOptionDisabled:function(n){this[n?"_disable":"_enable"]()},_disable:function(){var t=this;n.each(this.tooltips,function(i,r){var u=n.Event("blur");u.target=u.currentTarget=r.element[0];t.close(u,!0)});this.disabledTitles=this.disabledTitles.add(this.element.find(this.options.items).addBack().filter(function(){var t=n(this);if(t.is("[title]"))return t.data("ui-tooltip-title",t.attr("title")).removeAttr("title")}))},_enable:function(){this.disabledTitles.each(function(){var t=n(this);t.data("ui-tooltip-title")&&t.attr("title",t.data("ui-tooltip-title"))});this.disabledTitles=n([])},open:function(t){var r=this,i=n(t?t.target:this.element).closest(this.options.items);i.length&&!i.data("ui-tooltip-id")&&(i.attr("title")&&i.data("ui-tooltip-title",i.attr("title")),i.data("ui-tooltip-open",!0),t&&t.type==="mouseover"&&i.parents().each(function(){var t=n(this),i;t.data("ui-tooltip-open")&&(i=n.Event("blur"),i.target=i.currentTarget=this,r.close(i,!0));t.attr("title")&&(t.uniqueId(),r.parents[this.id]={element:this,title:t.attr("title")},t.attr("title",""))}),this._registerCloseHandlers(t,i),this._updateContent(i,t))},_updateContent:function(n,t){var r,i=this.options.content,u=this,f=t?t.type:null;if(typeof i=="string"||i.nodeType||i.jquery)return this._open(t,n,i);r=i.call(n[0],function(i){u._delay(function(){n.data("ui-tooltip-open")&&(t&&(t.type=f),this._open(t,n,i))})});r&&this._open(t,n,r)},_open:function(t,i,r){function s(n){(o.of=n,u.is(":hidden"))||u.position(o)}var f,u,h,e,o=n.extend({},this.options.position);if(r){if(f=this._find(i),f){f.tooltip.find(".ui-tooltip-content").html(r);return}i.is("[title]")&&(t&&t.type==="mouseover"?i.attr("title",""):i.removeAttr("title"));f=this._tooltip(i);u=f.tooltip;this._addDescribedBy(i,u.attr("id"));u.find(".ui-tooltip-content").html(r);this.liveRegion.children().hide();e=n("<div>").html(u.find(".ui-tooltip-content").html());e.removeAttr("name").find("[name]").removeAttr("name");e.removeAttr("id").find("[id]").removeAttr("id");e.appendTo(this.liveRegion);this.options.track&&t&&/^mouse/.test(t.type)?(this._on(this.document,{mousemove:s}),s(t)):u.position(n.extend({of:i},this.options.position));u.hide();this._show(u,this.options.show);this.options.track&&this.options.show&&this.options.show.delay&&(h=this.delayedShow=setInterval(function(){u.is(":visible")&&(s(o.of),clearInterval(h))},n.fx.interval));this._trigger("open",t,{tooltip:u})}},_registerCloseHandlers:function(t,i){var r={keyup:function(t){if(t.keyCode===n.ui.keyCode.ESCAPE){var r=n.Event(t);r.currentTarget=i[0];this.close(r,!0)}}};i[0]!==this.element[0]&&(r.remove=function(){this._removeTooltip(this._find(i).tooltip)});t&&t.type!=="mouseover"||(r.mouseleave="close");t&&t.type!=="focusin"||(r.focusout="close");this._on(!0,i,r)},close:function(t){var u,f=this,i=n(t?t.currentTarget:this.element),r=this._find(i);if(!r){i.removeData("ui-tooltip-open");return}(u=r.tooltip,r.closing)||(clearInterval(this.delayedShow),i.data("ui-tooltip-title")&&!i.attr("title")&&i.attr("title",i.data("ui-tooltip-title")),this._removeDescribedBy(i),r.hiding=!0,u.stop(!0),this._hide(u,this.options.hide,function(){f._removeTooltip(n(this))}),i.removeData("ui-tooltip-open"),this._off(i,"mouseleave focusout keyup"),i[0]!==this.element[0]&&this._off(i,"remove"),this._off(this.document,"mousemove"),t&&t.type==="mouseleave"&&n.each(this.parents,function(t,i){n(i.element).attr("title",i.title);delete f.parents[t]}),r.closing=!0,this._trigger("close",t,{tooltip:u}),r.hiding||(r.closing=!1))},_tooltip:function(t){var i=n("<div>").attr("role","tooltip"),r=n("<div>").appendTo(i),u=i.uniqueId().attr("id");return this._addClass(r,"ui-tooltip-content"),this._addClass(i,"ui-tooltip","ui-widget ui-widget-content"),i.appendTo(this._appendTo(t)),this.tooltips[u]={element:t,tooltip:i}},_find:function(n){var t=n.data("ui-tooltip-id");return t?this.tooltips[t]:null},_removeTooltip:function(n){n.remove();delete this.tooltips[n.attr("id")]},_appendTo:function(n){var t=n.closest(".ui-front, dialog");return t.length||(t=this.document[0].body),t},_destroy:function(){var t=this;n.each(this.tooltips,function(i,r){var f=n.Event("blur"),u=r.element;f.target=f.currentTarget=u[0];t.close(f,!0);n("#"+i).remove();u.data("ui-tooltip-title")&&(u.attr("title")||u.attr("title",u.data("ui-tooltip-title")),u.removeData("ui-tooltip-title"))});this.liveRegion.remove()}});n.uiBackCompat!==!1&&n.widget("ui.tooltip",n.ui.tooltip,{options:{tooltipClass:null},_tooltip:function(){var n=this._superApply(arguments);return this.options.tooltipClass&&n.tooltip.addClass(this.options.tooltipClass),n}});fr=n.ui.tooltip});var smartScroll=function(n,t){"use strict";function u(t){return n("#"+t.data("scroll").replace(/^#+/,""))}function f(t){i.each(function(){var i=u(n(this));r.scrollTop()>=n(i).offset().top-t.offset-10&&n(this).parent().addClass(t.activeClass).siblings().removeClass(t.activeClass)})}var r=n(t),i=n("*[data-scroll]");return{init:function(t,e){e="function"==typeof e?e:function(){return null};"function"==typeof t&&(e=t);var o={speed:(t="object"==typeof t?t:{}).speed||500,addActive:t.addActive||!0,activeClass:t.activeClass||"active",offset:t.offset||100};!function(t,r){if(i.length<=0)throw new Error("data-scroll attr must be added");i.each(function(){var i=n(this);i.on("click",function(r){r.preventDefault();var f=u(i);try{n("body, html").animate({scrollTop:f.offset().top-t.offset},t.speed)}catch(n){throw new Error("id:"+i.data("scroll")+" cannot be found please make sure to add [data-scroll] attr value as id for an elemet");}})});r()}(o,e);o.addActive&&(f(o),r.on("scroll",function(){f(o)}))}}}(jQuery,window);$(document).ready(function(){var n=$("#nb-navigation-type-03"),t=n.offset().top,i=$("#nbFixTablert");t>10?n.addClass("nb-nav-fix"):n.removeClass("nb-nav-fix");$(window).scroll(function(){$(this).scrollTop()>=5?n.addClass("nb-nav-fix"):n.removeClass("nb-nav-fix")})}),function(n){"use strict";var t=n(window).outerWidth();t>1025?smartScroll.init({speed:800,addActive:!0,activeClass:"active",offset:80},function(){console.log("callback")}):t<=1024&&smartScroll.init({speed:800,addActive:!0,activeClass:"active",offset:60},function(){console.log("callback")})}(jQuery);$(document).ready(function(){var n=$("#nb-scrollTop"),t=$(window).scrollTop();t>100?n.addClass("show"):n.removeClass("show");$(window).scroll(function(){$(this).scrollTop()>100?n.addClass("show"):n.removeClass("show")});n.click(function(n){return n.preventDefault(),$("html, body").animate({scrollTop:0},800),!1})});jQuery(document).ready(function(n){n(".cd-popup-trigger").on("click",function(t){if(t.preventDefault(),n(".cd-popup").addClass("is-visible"),n(this).hasClass("orderNow"))n(".cd-popup-container .blogForm").css("display","block"),n(".cd-popup-container .blogImg").css("display","none");else{n(".cd-popup-container .blogForm").css("display","none");n(".cd-popup-container .blogImg").css("display","block");var i=n(this).find("img").attr("src");n(".cd-popup-container .blogImg").children(".imgZoom").attr("src",i)}});n(".cd-popup").on("click",function(t){(n(t.target).is(".cd-popup-close")||n(t.target).is(".cd-popup"))&&(t.preventDefault(),n(this).removeClass("is-visible"))});n(document).keyup(function(t){t.which=="27"&&n(".cd-popup").removeClass("is-visible")})});$(document).ready(function(){var n=$("#nb-navigation-type-03"),i=n.find(".togelle"),t=n.find(".blogMenu");i.on("click",function(i){i.preventDefault();$(this).hasClass("active")?($(this).removeClass("active"),t.removeClass("open"),$("body").removeClass("tablert"),n.removeClass("op_menu")):($(this).addClass("active"),t.addClass("open"),$("body").addClass("tablert"),n.addClass("op_menu"));i.stopPropagation()});$(document).click(function(){var r=$(window).outerWidth();r<1025&&(i.removeClass("active"),t.removeClass("open"),$("body").removeClass("tablert"),n.removeClass("op_menu"))})});$(document).ready(function(){var i=$(window).outerWidth(),r=$("#nb-navigation-type-03"),t,n;i<=992&&(t=$(".foot_main .blogMXH").outerHeight(),n=$(".foot_main .orderBlog").outerHeight(),$(".foot_main").css("padding-top",t+n),$(".foot_main .blogMXH").css("top",n))});